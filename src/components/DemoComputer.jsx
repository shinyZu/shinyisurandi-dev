...
const DemoComputer = (props) => {
  ...
  // add animation to computer model when switching between projects
  useGSAP(() => {
    gsap.from(refComputerGroup.current.rotation, {
      y: Math.PI / 2,
      duration: 1,
      ease: "power3.out",
    });
  ...
  return (
    <group ref={refComputerGroup} {...props} dispose={null}>
      <group name="Scene">
        <mesh
          name="monitor-screen"
          castShadow
